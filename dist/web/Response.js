...
class Response extends Response_1.default {
    ...
    constructor(response) {
        super(response);
        this.encoding = Candy_1.default.app.encoding;
        //this.version = '1.1';
        this.statusCode = 200;
        this.statusText = 'OK';
        this.headers = {};
    ...
    setStatusCode(value, text) {
        if (value < 100 || value >= 600) {
            throw new HttpException_1.default('The HTTP status code is invalid');
        }
    ...
    setCookie(name, value, options) {
        ...
        var cookie = new Cookie_1.default(name, encodeURIComponent(value), options['expires'], options['path'], options['domain'], options['secure'], options['httpOnly']);
    ...
    sendHeaders() {
        ...
        if (this.cookies.length > 0) {
            Cookie_1.default.setCookie(this.response, this.cookies);
        }
